...
public class InjectedCounterStatefulRemoteImpl implements CounterStatefulRemote {
    ...
    public void increment() {
        memory.putInMemory(arithmeticOperations.add(memory.getMemory(), 1));
    }

    public void decrement() {
        memory.putInMemory(arithmeticOperations.subtract(memory.getMemory(), 1));
    }
